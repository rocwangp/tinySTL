...
namespace tinystl{
	namespace StringTest{
		...
		void testCase20(){
            /* stdStr s1("The sixth sick sheik's sixth sheep's sick."); */
            /* stdStr k1("sixth"); */
			/* tsStr str("The sixth sick sheik's sixth sheep's sick."); */
			/* tsStr key("sixth"); */

            /* assert(str.rfind(key) == s1.rfind(k1)); */
            /* std::cout << s1.rfind(k1, 24) << std::endl; */
            /* std::cout << str.rfind(key, 24) << std::endl; */
            /* assert(str.rfind(key, 24) == s1.rfind(k1, 24)); */
            /* assert(str.rfind('.') == s1.rfind('.')); */
            /* assert(str.rfind("The") == s1.rfind("The")); */
            /* assert(str.rfind("sick111", 10, 4) == s1.rfind("sick111", 10, 4)); */
